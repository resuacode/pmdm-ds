...
# Enunciados para ejercicios de ejemplo
...
### [Solución en Github](https://github.com/resuadam2/ListaCompraCompose)
### [Vídeos solucionandolo](./11-ejercicios-resueltos-explicados.mdx#app-de-la-lista-de-la-compra-o-to-do-list)
...
### [Solución en Github usando la API de Open Trivia Database](https://github.com/resuadam2/TriviaApp/tree/first-api-version)
