...
En proyectos Compose actuales se usa **Material 3**. Puedes personalizar colores, tipografía y formas y aplicarlos con `MaterialTheme`.
...
En el ejemplo anterior se aplica un tema Material 3 con `colorScheme`, tipografía y formas. Más detalle en la sección de [Material Design](./25-material-design.mdx).
