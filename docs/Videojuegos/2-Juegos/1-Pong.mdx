...
En este tutorial usamos el **Input Manager** clásico. El **Input System** moderno se menciona en [Scripting](../1-Unity/9-Scripting.mdx); no es necesario cambiarlo para completar Pong.
:::

:::tip[Input.GetAxisRaw() vs Input.GetAxis()]
...
![WinnerScene](../../../static/img/apuntes_unity/pong/WinnerScene.png)
...
![WinnerText](../../../static/img/apuntes_unity/pong/WinnerText.png)
:::
...
![WinnerScene 2](../../../static/img/apuntes_unity/pong/WinnerScene2.png)
...
![Build Profile](../../../static/img/apuntes_unity/pong/build_profile_1.png)
...
![Build Profile 2](../../../static/img/apuntes_unity/pong/build_profile_2.png)
...
![Build Profile 3](../../../static/img/apuntes_unity/pong/build_profile_3.png)
...
![Build Profile 4](../../../static/img/apuntes_unity/pong/build_profile_4.png)
...
![Build Profile 5](../../../static/img/apuntes_unity/pong/build_profile_5.png)
...
Y un largo etcétera.
Podéis hacer lo que queráis, la idea es que aprendáis a programar y a hacer juegos. Si tenéis alguna duda o sugerencia, no dudéis en preguntar.

## Referencias y tutoriales relacionados con este juego

- [Making Pong in Unity 2D - Lista de tutoriales de Erkberg The Greenening en YT](https://www.youtube.com/watch?v=DnBTmYXThOY&list=PLEl7CIZGv53xhngxJdS_GAaSXpXcN-hSP)
- [Pong en 10 minutos - Indierama en YT](https://www.youtube.com/watch?v=Iljcp9QERfQ&t=2s)
- [Cómo crear PONG en Unity - Lista de tutoriales de LuisCanary en YT](https://www.youtube.com/watch?v=Mk8e5an2mG8&list=PLNEAWvYbJJ9ltqR_CI5-ZV7p6Emz-v-di)
