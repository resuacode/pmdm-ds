...
:::warning[Errores en este punto]
Es posible que la consola de Unity comience a decirnos que hay algún error, esto es porque todavía no hemos añadido las escenas al array de escenas del proyecto, ahora lo solucionamos.
:::
